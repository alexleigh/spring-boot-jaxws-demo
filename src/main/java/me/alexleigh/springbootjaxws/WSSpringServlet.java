 ...
 *
 * This class was copied from the JAX-WS Commons Spring extension, then modified
 * to also work with environments where the web application context is injected
 * rather than created internally (e.g. Servlet 3.0+ environments, and in
...
public class WSSpringServlet extends HttpServlet implements ApplicationContextAware {
    ...
    private static final long serialVersionUID = -2786173009814679146L;
